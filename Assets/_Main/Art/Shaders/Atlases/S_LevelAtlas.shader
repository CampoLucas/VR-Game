...
Shader "S_LevelAtlas"
{
	Properties
	{
		_T_Atlas_Rooms_Albedo02( "T_Atlas_Rooms_Albedo02", 2D ) = "white" {}
	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float lerpResult18_g18 = lerp( 0.0 , 1.0 , break4_g18.x);
				float lerpResult21_g18 = lerp( 0.0 , 1.0 , break4_g18.y);
				float lerpResult23_g18 = lerp( 0.0 , 1.0 , break4_g18.z);
				...
				float3 Color = ( tex2D( _T_Atlas_Rooms_Albedo02, input.ase_texcoord3.xy ).rgb * lerpResult7_g18 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;10;-832,-0.5;Inherit;True;Property;_T_Atlas_Rooms_Albedo02;T_Atlas_Rooms_Albedo02;0;0;Create;True;0;0;0;False;0;False;-1;dd2d9f1ebfdb06247bd807dbfcbef4ae;dd2d9f1ebfdb06247bd807dbfcbef4ae;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;-1328,0;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-784,640;Inherit;False;Property;_ShadowColor;Shadow Color;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.09999985,0.1499999,0.2499999,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;18;-185.6241,-64.13766;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=19C5450962B23D6D4BEF555203776045E0B2FBBC