...
namespace VRGame.General.Interactables
{
    public class GearSnapPoint : SnapInteractable, IGameObjectFilter
    {
        ...
        public bool HasGear => currentGear;
        ...
        public ISubject<int, bool> OnGearChanged { get; private set; } = new Subject<int, bool>();
...
//             }
        ...
        private void SnapOn(Gear gear, SnapInteractor interactor)
        {
            ...
            OnGearChanged.NotifyAll(Identifier, true);
            //enabled = false;
        }
        ...
        private void SnapOff(Gear gear)
        {
            ...
            OnGearChanged.NotifyAll(Identifier ,false);
            //enabled = true;
        }
